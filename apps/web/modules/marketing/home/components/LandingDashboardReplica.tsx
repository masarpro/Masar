...
export function LandingDashboardReplica() {
	...
	return (
		...
		>
			<div
				ref={innerRef}
				className="pointer-events-none flex origin-top-left select-none gap-4 rounded-[24px] bg-white p-4 rtl:origin-top-right"
				style={{
					color: INK,
					width: BASE_WIDTH,
