...
const TIPS = [
	{ key: "quantitySmart", href: "/pricing/studies", gradient: "from-chart-4 to-chart-4" },
	...
	{ key: "ganttChart", href: "/projects", gradient: "from-indigo-500/10 to-chart-4" },
	{ key: "subcontractors", href: "/projects", gradient: "from-rose-500/10 to-pink-500/10" },
	{ key: "dailyReports", href: "/projects", gradient: "from-chart-4 to-chart-4" },
	...
	{ key: "payrollSystem", href: "/company/payroll", gradient: "from-teal-500/10 to-chart-4" },
	{ key: "documentVersions", href: "/projects", gradient: "from-chart-4 to-indigo-500/10" },
	{ key: "approvalWorkflow", href: "/projects", gradient: "from-green-500/10 to-lime-500/10" },
	{ key: "cashFlow", href: "/finance/reports", gradient: "from-chart-4 to-chart-4" },
	...
	{ key: "quotationGen", href: "/pricing/quotations", gradient: "from-chart-4 to-chart-4" },
	...
	{ key: "claimsWorkflow", href: "/projects", gradient: "from-chart-4 to-chart-4" },
	{ key: "boqSummary", href: "/pricing/studies", gradient: "from-lime-500/10 to-green-500/10" },
	{ key: "heightDerivation", href: "/pricing/studies", gradient: "from-chart-4 to-purple-500/10" },
...
export function DidYouKnowCard({ organizationSlug }: DidYouKnowCardProps) {
	...
	return (
		<div
			className="relative overflow-hidden rounded-2xl border border-chart-4 dark:border-chart-4 backdrop-blur-xl bg-gradient-to-br from-chart-4/15 via-chart-4/15 to-chart-4/15 dark:from-chart-4/20 dark:via-chart-4/20 dark:to-chart-4/20 shadow-lg shadow-chart-4 p-2.5 flex flex-col flex-1"
		>
			{/* Header */}
