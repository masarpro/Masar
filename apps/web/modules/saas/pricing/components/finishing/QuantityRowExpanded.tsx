...
export const QuantityRowExpanded = memo(function QuantityRowExpanded({
	...
	return (
		<div className="border-t bg-muted/30 border-s-2 border-primary/30">
			{/* Details */}
			<div className="px-5 py-4 space-y-3 text-sm">
					...
					{item.calculationBreakdown && (
						<div className="space-y-2">
							...
							<div className="rounded-lg bg-muted/40 border border-border p-4 text-sm font-mono whitespace-pre-wrap leading-relaxed" dir="ltr">
					...
					{/* Links — feeds */}
					{feedsItems.length > 0 && (
						<div className="flex items-start gap-2 text-sm text-muted-foreground rounded-lg bg-success/10 p-2.5">
							<ArrowDown className="h-3.5 w-3.5 text-success mt-0.5 shrink-0" />
