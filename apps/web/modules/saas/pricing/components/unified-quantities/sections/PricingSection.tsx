...
export function PricingSection({ item, globalMarkupPercent }: Props) {
	...
	return (
		<Card className="border-2 border-chart-4/30 bg-card p-4">
			<div className="space-y-4">
				{/* Header row — title + custom-markup toggle */}
				<div className="flex flex-wrap items-center justify-between gap-2">
					<div className="flex flex-col gap-0.5">
						<h4 className="text-sm font-semibold text-chart-4">
				...
				{/* Profit recap */}
				<div className="rounded-lg border border-chart-4/30 bg-background p-3">
