	...
	},
	{
		...
		routes: [
			...
			},
			{
				...
				label: "الدفعات والمستخلصات",
				labelEn: "Payments & Claims",
				icon: Banknote,
			},
			{
				id: "finance-subcontracts",
				path: "finance/subcontracts",
				label: "مقاولو الباطن",
				labelEn: "Subcontracts",
				icon: Hammer,
			},
		],
	},
...
export const NAV_GROUP_CONFIG: NavGroupConfig[] = [
	...
	},
	{
		...
		icon: Hammer,
		type: "direct",
		sectionIds: ["subcontracts"],
		directSectionId: "subcontracts",
		showInMobileDock: true,
	},
	{
		id: "expenses",
		labelKey: "projects.shell.navigation.expenses",
		icon: Receipt,
		type: "direct",
		sectionIds: ["expenses"],
		directSectionId: "expenses",
		showInMobileDock: true,
	},
	{
		id: "payments",
		labelKey: "projects.shell.navigation.payments",
		icon: Banknote,
		type: "direct",
		sectionIds: ["payments"],
		directSectionId: "payments",
		showInMobileDock: true,
	},
	{
		id: "workspace",
	...
	"finance/subcontracts": [
		{
			id: "new-subcontract",
			label: "عقد باطن جديد",
			labelEn: "New Subcontract",
			icon: Hammer,
			href: "finance/subcontracts/new",
			variant: "primary",
		},
	],
	"finance/claims": [
