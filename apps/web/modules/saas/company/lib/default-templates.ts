...
export const INVOICE_TEMPLATE_BOLD_PROFESSIONAL: DefaultTemplateConfig = {
	...
	description: "تصميم جريء مع هيدر داكن ولمسات زرقاء",
	descriptionAr:
		"تصميم جريء واحترافي مع هيدر داكن ولمسات زرقاء — مثالي لشركات المقاولات",
	descriptionEn:
		"Bold professional design with dark header and blue accents — perfect for construction companies",
	templateType: "INVOICE",
	settings: {
		backgroundColor: "#ffffff",
		primaryColor: "#0ea5e9",
	...
	elements: [
		...
		},
		{
			...
			settings: {
				...
				headerTextColor: "#ffffff",
				rowNumberColor: "#0ea5e9",
				rowBorderColor: "#f1f5f9",
				headerRowNumberColor: "#0ea5e9",
				borderRadius: "6px",
			},
		},
		{
...
export const TEMPLATE_COLORS = [
	...
	{ value: "#0ea5e9", label: "سماوي فاتح", labelEn: "Sky Blue" },
