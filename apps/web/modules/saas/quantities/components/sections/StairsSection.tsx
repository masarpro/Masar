					...
					<CardContent className="p-4 space-y-4">
						...
						<div className="border rounded-lg p-4 bg-slate-50/30 dark:bg-slate-900/30">
							...
							<div className="grid grid-cols-2 md:grid-cols-5 gap-4">
								...
								<div>
									<Label>طول الجزء المائل ({t("quantities.units.m")})</Label>
									<Input
										type="number"
										step="0.1"
										min={0}
								...
								<div>
									<Label>طول البسطة ({t("quantities.units.m")})</Label>
									<Input
										type="number"
										step="0.1"
										min={0}
						...
						<div className="border rounded-lg p-4 bg-amber-50/30 dark:bg-amber-900/20">
							...
							<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
								...
								<div>
									<Label>ارتفاع القائمة ({t("quantities.units.cm")})</Label>
									<Select
								...
								<div>
									<Label>عمق النائمة ({t("quantities.units.cm")})</Label>
									<Select
