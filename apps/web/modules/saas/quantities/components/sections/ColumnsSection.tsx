						...
						<TableHeader>
							<TableRow>
								<TableHead className="text-right">
									{t("quantities.structural.itemName")}
								</TableHead>
								<TableHead className="text-right">
									{t("quantities.structural.quantity")}
								</TableHead>
								<TableHead className="text-right">
									{t("quantities.form.dimensions")}
								</TableHead>
								<TableHead className="text-right">
							...
							{items.map((item) => (
								<TableRow key={item.id}>
									...
									<TableCell>
										...
										{t("quantities.units.cm")} × {item.dimensions?.height || 0}{" "}
										{t("quantities.units.m")}
									</TableCell>
									<TableCell>
						...
						{calculations && (
							<div className="bg-muted/50 rounded-lg p-4 space-y-4">
								<div className="flex items-center gap-2 mb-3">
									...
									<h4 className="font-medium">
										{t("quantities.calculations.results")}
									</h4>
								</div>
								<CalculationResultsPanel
									concreteVolume={calculations.concreteVolume}
			...
			{items.length > 0 && (
				<div className="bg-muted/30 rounded-lg p-4">
					<h4 className="font-medium mb-2">
						{t("quantities.summary.totalItems")}
					</h4>
