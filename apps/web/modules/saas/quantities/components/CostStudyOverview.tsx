	...
	if (!study) {
		return (
			<div className="flex flex-col items-center justify-center py-20 text-center">
				...
				<p className="text-muted-foreground text-lg">{t("quantities.notFound")}</p>
			</div>
		);
	}
			...
			<div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
				...
				<div className="flex items-center gap-6 bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4">
					<div className="text-center">
						<p className="text-xs text-slate-500 dark:text-slate-400">{t("quantities.form.buildingArea")}</p>
						<p className="text-lg font-semibold text-slate-900 dark:text-slate-100">{study.buildingArea} م²</p>
					</div>
					<div className="w-px h-10 bg-slate-200 dark:bg-slate-700" />
					<div className="text-center">
						<p className="text-xs text-slate-500 dark:text-slate-400">{t("quantities.form.numberOfFloors")}</p>
						<p className="text-lg font-semibold text-slate-900 dark:text-slate-100">{study.numberOfFloors}</p>
					</div>
					<div className="w-px h-10 bg-slate-200 dark:bg-slate-700" />
					<div className="text-center">
						<p className="text-xs text-slate-500 dark:text-slate-400">{t("quantities.totalCost")}</p>
			...
			<div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
				<div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50">
					<div className="flex items-center gap-3">
						...
						<div>
							<p className="text-xs text-slate-500 dark:text-slate-400">{t("quantities.form.projectType")}</p>
							<p className="font-medium text-slate-900 dark:text-slate-100">{t(`quantities.projectTypes.${study.projectType}`)}</p>
						</div>
					</div>
				</div>
				<div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50">
					<div className="flex items-center gap-3">
						...
						<div>
							<p className="text-xs text-slate-500 dark:text-slate-400">{t("quantities.form.numberOfFloors")}</p>
							<p className="font-medium text-slate-900 dark:text-slate-100">{study.numberOfFloors} {t("quantities.floors")}</p>
						</div>
					</div>
				</div>
				<div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50">
				...
				<div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50">
					<div className="flex items-center gap-3">
						...
						<div>
							<p className="text-xs text-slate-500 dark:text-slate-400">{t("quantities.form.finishingLevel")}</p>
							<p className="font-medium text-slate-900 dark:text-slate-100">{t(`quantities.finishingLevels.${study.finishingLevel}`)}</p>
						</div>
					</div>
				</div>
			</div>
					...
					<Link key={section.href} href={section.href}>
						<div className={`group rounded-2xl ${section.bg} p-5 transition-all duration-200 hover:shadow-sm`}>
							...
							<div className="flex items-end justify-between">
								<div>
									<p className="text-xs text-slate-500 dark:text-slate-400">{t("quantities.items")}</p>
			...
			<div className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 overflow-hidden">
				...
				<div className="p-5 border-b border-slate-100 dark:border-slate-800">
					<div className="flex items-center gap-3">
						...
						<div>
							<h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">{t("quantities.costSummary")}</h2>
							<p className="text-sm text-slate-500 dark:text-slate-400">{t("quantities.costBreakdown")}</p>
						</div>
					</div>
				</div>
				...
				<div className="p-5">
					<div className="grid lg:grid-cols-2 gap-8">
						...
						<div className="space-y-4">
							{/* Direct Costs */}
							<div className="space-y-2">
								<h3 className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">{t("quantities.directCost")}</h3>
								...
								<div className="flex items-center justify-between p-3 rounded-xl bg-orange-50 dark:bg-orange-950/30">
									<div className="flex items-center gap-3">
										...
										<span className="text-slate-700 dark:text-slate-300">{t("quantities.structural.title")}</span>
									</div>
								...
								<div className="flex items-center justify-between p-3 rounded-xl bg-violet-50 dark:bg-violet-950/30">
									<div className="flex items-center gap-3">
										...
										<span className="text-slate-700 dark:text-slate-300">{t("quantities.finishing.title")}</span>
									</div>
								...
								<div className="flex items-center justify-between p-3 rounded-xl bg-sky-50 dark:bg-sky-950/30">
									<div className="flex items-center gap-3">
										...
										<span className="text-slate-700 dark:text-slate-300">{t("quantities.mep.title")}</span>
									</div>
								...
								<div className="flex items-center justify-between p-3 rounded-xl bg-teal-50 dark:bg-teal-950/30">
									<div className="flex items-center gap-3">
										...
										<span className="text-slate-700 dark:text-slate-300">{t("quantities.labor")}</span>
									</div>
							...
							<div className="space-y-2 pt-4 border-t border-slate-100 dark:border-slate-800">
								<h3 className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">{t("quantities.overhead")} & {t("quantities.profit")}</h3>

								<div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50">
									<span className="text-slate-600 dark:text-slate-400">{t("quantities.overhead")} ({study.overheadPercent}%)</span>
									<span className="font-medium text-slate-900 dark:text-slate-100">{formatCurrency(overheadAmount)}</span>
								</div>

								<div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50">
									<span className="text-slate-600 dark:text-slate-400">{t("quantities.profit")} ({study.profitPercent}%)</span>
									<span className="font-medium text-slate-900 dark:text-slate-100">{formatCurrency(profitAmount)}</span>
								</div>

								{study.vatIncluded && (
									<div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50">
										<span className="text-slate-600 dark:text-slate-400">{t("quantities.vat")} (15%)</span>
						...
						<div className="flex flex-col justify-center">
							<div className="p-8 rounded-2xl bg-slate-50 dark:bg-slate-800/50 text-center">
								<p className="text-sm text-slate-500 dark:text-slate-400 mb-2">{t("quantities.total")}</p>
								<p className="text-4xl lg:text-5xl font-bold text-slate-900 dark:text-slate-100">
									{formatCurrency(study.totalCost)}
								</p>
								<p className="text-sm text-slate-500 dark:text-slate-400 mt-4">
									{t("quantities.includeVat")}: {study.vatIncluded ? t("common.yes") || "Yes" : t("common.no") || "No"}
								</p>
							</div>
						</div>
					</div>
