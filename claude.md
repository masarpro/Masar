...
│   │   │       ├── finance/           # النظام المالي (42+ pages)
...
- **114 model** + **74 enum** في Prisma Schema (~4,658 سطر)
...
*هذا الملف يُحدّث مع كل تطوير كبير. آخر مراجعة: 2026-03-17*