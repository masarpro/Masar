...
function getPermissionErrorMessage(section: keyof Permissions, action: string): string {
	const sectionMessages: Record<keyof Permissions, Record<string, string>> = {
		...
		pricing: {
			...
			editQuantities: "ليس لديك صلاحية تعديل الكميات",
			approveQuantities: "ليس لديك صلاحية اعتماد مرحلة الكميات",
			editSpecs: "ليس لديك صلاحية تعديل المواصفات",
			approveSpecs: "ليس لديك صلاحية اعتماد مرحلة المواصفات",
			editCosting: "ليس لديك صلاحية تعديل التكاليف",
			approveCosting: "ليس لديك صلاحية اعتماد مرحلة التكاليف",
			editSellingPrice: "ليس لديك صلاحية تعديل سعر البيع",
			generateQuotation: "ليس لديك صلاحية إنشاء عرض السعر",
			convertToProject: "ليس لديك صلاحية تحويل الدراسة لمشروع",
		},
		finance: {
